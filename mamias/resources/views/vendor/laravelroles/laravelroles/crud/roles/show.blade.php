                    ...
                    <div class="{{ $containerHeaderClass }}">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                @isset($typeDeleted)
                                    <a href="{{ route('laravelroles::roles-deleted') }}"
                                       class="btn btn-outline-danger btn-sm float-right" data-toggle="tooltip"
                                       data-placement="left"
                    ...
                    <div class="{{ $containerBodyClass }}">
                        <ul class="list-group">
                            ...
                            <li id="accordion_roles_users"
                                ...
                                @if($item['users']->count() > 0)
                                    <div id="collapse_roles_users" class="collapse"
                                         data-parent="#accordion_roles_users">
                            ...
                            <li id="accordion_roles_permissions"
                                ...
                                @if($item['permissions']->count() > 0)
                                    <div id="collapse_roles_permissions" class="collapse"
                                         data-parent="#accordion_roles_permissions">
                                        <table class="table table-striped table-sm mt-3">
                                            <caption>
