                            ...
                            <div class="btn-group pull-right btn-group-xs">
                                ...
                                @else
                                    <a href="{{ route('users.create') }}" class="btn btn-default btn-sm pull-right"
                                       ...
                                       title="{!! trans('laravelusers::laravelusers.tooltips.create-new') !!}">
                                        @if(config('laravelusers.fontAwesomeEnabled'))
                                            <i class="fa fa-fw fa-user-plus" aria-hidden="true"></i>
                                        @endif
                                        {!! trans('laravelusers::laravelusers.buttons.create-new') !!}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success btn-block"
                                               ...
                                               title="{!! trans('laravelusers::laravelusers.tooltips.show') !!}">
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-info btn-block"
                                               ...
                                               data-toggle="tooltip"
                                               title="{!! trans('laravelusers::laravelusers.tooltips.edit') !!}">
