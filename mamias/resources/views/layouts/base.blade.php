...
<head>
    ...
    <title>MAMIAS | @yield('title')</title>


    <link rel="apple-touch-icon" href="{{ asset('app-assets/images/ico/apple-icon-120.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('app-assets/images/ico/favicon.ico') }}">
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,600%7CIBM+Plex+Sans:300,400,500,600,700"
          rel="stylesheet">
    ...
    <div class="navbar-header d-xl-block d-none">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item"><a class="navbar-brand" href="{{url('/')}}">
                    <div class="brand-logo"><img class="logo" src="{{ asset('app-assets/logos/logo.png') }}"></div>
            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right d-flex align-items-center">
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link"
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag"><a class="dropdown-item" href="#"
                                    ...
                                    class="flag-icon flag-icon-fr mr-50"></i>French</a><a class="dropdown-item" href="#"
                                                                                          data-language="de"><i
                                    class="flag-icon flag-icon-de mr-50"></i>German</a><a class="dropdown-item" href="#"
                                                                                          data-language="pt"><i
                    ...
                    @if (Route::has('login'))
                        @auth
                            <li class="dropdown dropdown-user nav-item"><a
                                    ...
                                    <div class="user-nav d-lg-flex d-none"><span
                                            class="user-name">{{ Auth::user()->username }}</span><span
                                            class="user-status">Available</span></div>
                                    <div class="avatar mr-1 bg-primary avatar-sm bg-lighten-2">
                                        <span class="avatar-content">{{ Auth::user()->getInitials() }}</span>
                                    </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-right pb-0">
                                    ...
                                    <a class="dropdown-item" href="app-email.html"><i class="bx bx-envelope mr-50"></i>
                                        My Inbox</a>
                                    <a class="dropdown-item" href="app-todo.html"><i
                                            class="bx bx-check-square mr-50"></i> Task</a>
                                    <a class="dropdown-item" href="app-chat.html"><i class="bx bx-message mr-50"></i>
                                        Chats</a>
                        ...
                        @else
                            <li class="nav-item d-none d-lg-block"><a href="{{ route('login') }}" class="nav-link "><i
                                        class="ficon bx bx-log-in"></i></a></li>

                            @if (Route::has('register'))
                                <li class="nav-item d-none d-lg-block"><a href="{{ route('register') }}"
                                                                          class="nav-link "><i
                                            class="ficon bx bx-user-plus"></i></a></li>
...
<div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-fixed navbar-light navbar-without-dd-arrow"
    ...
    <div class="navbar-header d-xl-none d-block">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html">
                    <div class="brand-logo"><img class="logo" src="{{ asset('app-assets/logos/l.png') }}"></div>
                    <!--<h2 class="brand-text mb-0">Frest</h2>-->
                </a></li>
    ...
    <div class="navbar-container main-menu-content" data-menu="menu-container">
        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="filled">
            <li class="dropdown nav-item" data-menu="dropdown"><a class="nav-link" href="{{url('/')}}"><i
                        class="menu-livicon" data-icon="home"></i><span data-i18n="Home">Home</span></a>
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                  data-toggle="dropdown"><i class="menu-livicon"
                                                                                            data-icon="comments"></i><span>Apps</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                        ...
                        <ul class="dropdown-menu">
                            <li data-menu=""><a class="dropdown-item align-items-center" href="app-invoice-list.html"
                                                data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>Invoice List</a>
                            </li>
                            ...
                            <li data-menu=""><a class="dropdown-item align-items-center" href="app-invoice-edit.html"
                                                data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>Invoice Edit</a>
                            </li>
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                  data-toggle="dropdown"><i class="menu-livicon"
                                                                                            data-icon="briefcase"></i><span>UI</span></a>
                <ul class="dropdown-menu">
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            class="dropdown-item align-items-center dropdown-toggle" href="#" data-toggle="dropdown"><i
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                  data-toggle="dropdown"><i class="menu-livicon"
                                                                                            data-icon="thumbnails-big"></i><span>Forms &amp; Tables</span></a>
                <ul class="dropdown-menu">
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            class="dropdown-item align-items-center dropdown-toggle" href="#" data-toggle="dropdown"><i
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li data-menu=""><a class="dropdown-item align-items-center" href="form-file-uploader.html"
                                                data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>File
                                    Uploader</a>
                            </li>
                            <li data-menu=""><a class="dropdown-item align-items-center"
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                  data-toggle="dropdown"><i class="menu-livicon"
                                                                                            data-icon="notebook"></i><span>Pages</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li data-menu=""><a class="dropdown-item align-items-center"
                                                ...
                                                data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>2
                                    columns</a>
                            </li>
                            <li data-menu=""><a class="dropdown-item align-items-center"
                            ...
                            <li data-menu=""><a class="dropdown-item align-items-center"
                                                ...
                                                data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>Static
                                    layout</a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                  data-toggle="dropdown"><i class="menu-livicon"
                                                                                            data-icon="pie-chart"></i><span>Charts &amp; Maps</span></a>
                <ul class="dropdown-menu">
            ...
            @auth
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i class="menu-livicon"
                                                                                                data-icon="gears"></i><span>Settings</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item align-items-center" href="/countries"
                                            data-toggle="dropdown"><i class="bx bx-chevrons-right"></i>Country</a>
                        </li>
                        <li data-menu=""><a class="dropdown-item align-items-center" href="/ecap" data-toggle="dropdown"
                                            target="_blank"><i class="bx bx-chevrons-right"></i>EcAp Sub-Rgions</a>
                        </li>
                        <li data-menu=""><a class="dropdown-item align-items-center" href="/ecap" data-toggle="dropdown"
                                            target="_blank"><i class="bx bx-chevrons-right"></i>Ecofunctional Groups</a>
                        </li>
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i class="menu-livicon"
                                                                                                data-icon="gear"></i><span>User Management</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu=""><a class="dropdown-item align-items-center" href="/user"
                                            data-toggle="dropdown"><i class="bx bx-chevrons-right"></i>User List</a>
                        </li>
                        <li data-menu=""><a class="dropdown-item align-items-center" href="/roles"
                                            data-toggle="dropdown" target="_blank"><i class="bx bx-chevrons-right"></i>Roles
                                & Permissions</a>
                        </li>
                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i class="menu-livicon"
                                                                                                data-icon="gear"></i><span>Dev Tools</span></a>
                    <ul class="dropdown-menu">
                        <li class="disabled" data-menu=""><a class="dropdown-item align-items-center" href="/log-viewer"
                                                             data-toggle="dropdown"><i class="bx bx-dashboard"></i>Logs
                                Dashboard</a>
                        </li>
                        <li data-menu=""><a class="dropdown-item align-items-center" href="/logs" data-toggle="dropdown"
                                            target="_blank"><i class="bx bx-file"></i>Logs</a>
                        </li>
                        <li data-menu=""><a class="dropdown-item align-items-center" href="/routes"
                                            data-toggle="dropdown" target="_blank"><i class="bx bx-menu"></i>Routes</a>
                        </li>
...
<footer class="footer footer-static footer-light">
    <p class="clearfix mb-0"><span class="float-left d-inline-block">2021 &copy; UNEP-MAP-SPA/RAC</span><span
            class="float-right d-sm-inline-block d-none">Crafted with<i
                class="bx bxs-heart pink mx-50 font-small-3"></i>by<a class="text-uppercase"
                                                                      href="mailto:atef.ouerghi@spa-rac.org"
                                                                      target="_blank">Atef OUERGHI</a></span>
